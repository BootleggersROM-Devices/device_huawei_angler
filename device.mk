...
ifneq ($(filter aosp_angler% bootleg_angler%, $(TARGET_PRODUCT)),)
PRODUCT_PROPERTY_OVERRIDES += \
...
$(call inherit-product, vendor/bootleggers/config/dalvik/phone-xxhdpi-3072-dalvik-heap.mk)
$(call inherit-product, vendor/bootleggers/config/dalvik/phone-xxhdpi-3072-hwui-memory.mk)
